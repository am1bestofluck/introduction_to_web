...
$expertise = [
    [
        'obj'       => 'front end developer',
        'proof'     => NULL,
        'start'     => 'Jan 2015',
        'till'      => 'current',
        'short_note'=> join(' ', ['Lorem ipsum dolor sit amet. Praesentium magnam', 
        ...
        'obj'       => 'web developer',
        'proof'     => 'something.com',
        'start'     => ucwords('Mar 2012'),
        'till'      => ucwords('dec 2014'),
        'short_note'=> join(' ',['Consectetur adipisicing elit. Praesentium magnam',
        'consectetur vel in deserunt aspernatur est reprehenderit sunt hic.',
        'Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste.'])
        ],
        [
        'obj'       => 'Graphic Designer',
        'proof'     => 'designsomething.com',
        'start'     => ucwords('jun 2010'),
        'till'      => ucwords('mar 2012'),
        'short_note'=> 'Lorem ipsum dolor sit amet, consectetur adipisicing elit.'
        ],
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          ...
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?=ucwords($expertise[$i]['start'])?> - <span class="w3-tag w3-teal w3-round"><?=ucwords($expertise[$i]['till'])?></span></h6>
          <p><?=$expertise[$i]['short_note']?></p>
          <hr>
          </div>
        <?php }?>
        <!--<span class="w3-tag w3-teal w3-round"><@?=ucwords($expertise[$i]['till'])?></span>-->
        <!--<div class="w3-container">-->
